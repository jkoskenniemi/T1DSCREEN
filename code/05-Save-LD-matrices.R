...
map2(names_gwas, trimmed_ld_matrices, ~{
  ...
  save(list = .x, file = paste0("data/export_LDmat/", .x, "_LDmat.rda"))
})
...
TYK2_SNPs_LD <- ld_matrix(
  variants = c(
    "rs34536443", #previously known top functional variant
    "rs12720356","rs2304256", #our top functional variants, see analyses/TYK2.Rmd
    "rs144309607", "rs34725611"), #top SNPs for TYK2 eQTL and T1D risk, see analyses/TYK2.Rmd
  pop = "EUR",
  plink_bin = genetics.binaRies::get_plink_binary(),
