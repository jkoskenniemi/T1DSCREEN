...
IL2RB_eqtl <- import_data("data/export/IL2RB_eqtl_TwoSampleMR.csv",
            "data/export/IL2RB_T1D_TwoSampleMR.csv", has_beta = TRUE)
...
ggsave(filename = "IL2RB.png", height = 8, width = 6)
```
...
IL2RB_eqtl_orig <- read_csv("data/export/IL2RB_eqtl_TwoSampleMR.csv")
IL2RB_eqtl_orig %>%
  filter(SNP == "rs143857582") #no

IL2RB_T1D <- read_csv("data/export/IL2RB_T1D_TwoSampleMR.csv")
IL2RB_T1D %>%
  filter(SNP == "rs143857582") #yes


IL2RB_eqtl_orig <- read_csv("data/export/IL2RB_eqtl_TwoSampleMR.csv")
IL2RB_eqtl_orig %>%
  filter(SNP == "rs149508414") #no

IL2RB_T1D <- read_csv("data/export/IL2RB_T1D_TwoSampleMR.csv")
IL2RB_T1D %>%
  filter(SNP == "rs149508414") #yes
