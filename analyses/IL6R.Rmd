...
```{r}
IL6R_eqtl <- read_exposure_data("data/export/IL6R_eqtl_TwoSampleMR.csv", sep=",")
IL6R_T1D  <- read_outcome_data("data/export/IL6R_T1D_TwoSampleMR.csv", sep=",")

IL6R <- harmonise_data(IL6R_eqtl, IL6R_T1D)
...
IL6R_eqtl.fig <-
  ...
  ggtitle("GWAS of IL6R gene expression in blood") +
  ylab("-log10(p)") +
  xlab(NULL)
...
fig_IL6R_manhattan <- ggarrange(IL6R_gene.fig, IL6R_eqtl.fig, IL6R_T1D.fig,
...
D1 <- list(
  ...
  MAF = IL6R$maf.exposure,
  pos = IL6R$pos.exposure,
  snp = IL6R$pos.outcome,
  sdY = 1)
...
D2 <- list(
  ...
  MAF = IL6R$maf.exposure,  #eqtl used here in purpose
...
```{r}
IL6R_prot <- read_exposure_data("data/export/IL6R_crp_TwoSampleMR.csv", sep=",")
IL6R_T1D  <- read_outcome_data("data/export/IL6R_T1D_TwoSampleMR.csv", sep=",")

IL6R <- harmonise_data(IL6R_prot, IL6R_T1D)
...
load(file = "data/IL6R_LDmat-2023-04-25.RData")
