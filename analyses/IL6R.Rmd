...
ggsave("figures/IL6R-pQTL-T1D-manhattan.png", height = 6, width = 6)
...
plot_coloc(genechr = 1,
           ...
           LDmat = IL6R)
ggsave(filename = "figures/IL6R_eqtl.png", height = 8, width = 6)
...
ggsave(filename = "figures/IL6R_pqtl.png", height = 8, width = 6)
```
