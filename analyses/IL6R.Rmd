...
## Manhattan plots
```{r}
manhattan_plots(IL6R_eqtl, gene_start=154405193, gene_end=154469450, title = "IL6R eQTL")
...
ggsave("figures/IL6R-eQTL-T1D-manhattan.pdf", height = 6, width = 6)

manhattan_plots(IL6R_pqtl, gene_start=154405193, gene_end=154469450, title = "IL6R pqtl")
IL6R_pqtl <- IL6R_pqtl %>% filter(pos.outcome > 154300000 & pos.outcome < 154700000) 
manhattan_plots(IL6R_pqtl, gene_start=154405193, gene_end=154469450, title = "IL6R")

ggsave("figures/IL6R-pQTL-T1D-manhattan.pdf", height = 6, width = 6)

```

## Coloc
```{r}
coloc_IL6R_eqtl <- analyze_coloc_eqtl(IL6R_eqtl)


load("data/export_LDmat/IL6R_pqtl_LDmat.rda")
IL6R_pqtl <- filter(IL6R_pqtl, pval.exposure > 0 & SNP %in% colnames(IL6R))
coloc_IL6R_pqtl <- analyze_coloc_eqtl(IL6R_pqtl)
...
load("data/export_LDmat/IL6R_eqtl_LDmat.rda")

plot_coloc(genechr = 1,
           fig_start = 154300000,
           fig_end = 154700000,
           coloc_results = coloc_IL6R_eqtl$coloc_D1D2,
           data = IL6R_eqtl,
           D1 = coloc_IL6R_eqtl$D1,
           D2 = coloc_IL6R_eqtl$D2,
           LDmat = IL6R)
ggsave(filename = "figures/IL6R_eqtl.pdf", height = 8, width = 6)
...
plot_coloc(genechr = 1,
           fig_start = 154300000,
           fig_end = 154700000,
           coloc_results = coloc_IL6R_pqtl$coloc_D1D2,
           data = IL6R_pqtl,
           D1 = coloc_IL6R_pqtl$D1,
           D2 = coloc_IL6R_pqtl$D2,
           LDmat = IL6R)

ggsave(filename = "figures/IL6R_pqtl.pdf", height = 8, width = 6)
```
...
#Find top SNP
coloc_IL6R_eqtl$coloc_D1D2$results$snp[which.max(coloc_IL6R_eqtl$coloc_D1D2$results$SNP.PP.H4)] #rs10908839
...
coloc_IL6R_pqtl <- analyze_coloc_pqtl_nosensitivitity(IL6R_pqtl)
```
