...
fig_IL6R_manhattan <- ggarrange(IL6R_gene.fig, IL6R_prot.fig, IL6R_T1D.fig,
...
IL6R <- IL6R %>% filter(!is.na(beta.exposure) & !is.na(beta.outcome) &
                          !is.na(maf.outcome))
...
# 
# save(ldmat_IL6R, file = "data/IL6R_LDmat-2023-04-25.RData")
