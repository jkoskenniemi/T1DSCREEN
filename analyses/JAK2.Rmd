...
load("data/export_LDmat/JAK2_eqtl_LDmat.rda")
...
ggsave(filename = "figures/JAK2.pdf", height = 8, width = 6)
```
...
#Select only rs41316003 (as p for its exposure is < 10^-5) and run MR
